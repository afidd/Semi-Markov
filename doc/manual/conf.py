...
# -*- coding: utf-8 -*-
#
# Semi-Markov documentation build configuration file, created by
...
htmlhelp_basename = 'Semi-Markovdoc'
...
man_pages = [
    ('index', 'semi-markov', 'Semi-Markov Documentation',
     ['Andrew Dolgert, David Schneider'], 1)
]
...
epub_title = 'Semi-Markov'
epub_author = 'Andrew Dolgert, David Schneider'
epub_publisher = 'Andrew Dolgert, David Schneider'
epub_copyright = '2014, Andrew Dolgert, David Schneider'
